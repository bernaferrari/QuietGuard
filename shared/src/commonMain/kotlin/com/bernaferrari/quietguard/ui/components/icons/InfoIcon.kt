...
internal val filledInfo: ImageVector
  get() {
    if (_filledInfo != null) {
      return _filledInfo!!
    }
...
internal var _filledInfo: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedInfo: ImageVector
  get() {
    if (_outlinedInfo != null) {
      return _outlinedInfo!!
    }
    _outlinedInfo =
      ImageVector.Builder(
          name = "info",
...
internal var _outlinedInfo: ImageVector? = null
