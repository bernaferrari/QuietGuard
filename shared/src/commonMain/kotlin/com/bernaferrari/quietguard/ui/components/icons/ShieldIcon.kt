...
internal val filledShield: ImageVector
  get() {
    if (_filledShield != null) {
      return _filledShield!!
    }
    _filledShield =
      ImageVector.Builder(
          name = "shield",
...
internal var _filledShield: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedShield: ImageVector
  get() {
    if (_outlinedShield != null) {
      return _outlinedShield!!
    }
    _outlinedShield =
      ImageVector.Builder(
          name = "shield",
...
internal var _outlinedShield: ImageVector? = null
