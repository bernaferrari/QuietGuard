...
internal val filledCheckCircle: ImageVector
  get() {
    if (_filledCheckCircle != null) {
      return _filledCheckCircle!!
    }
    _filledCheckCircle =
      ImageVector.Builder(
          name = "check_circle",
...
internal var _filledCheckCircle: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedCheckCircle: ImageVector
  get() {
    if (_outlinedCheckCircle != null) {
      return _outlinedCheckCircle!!
    }
    _outlinedCheckCircle =
      ImageVector.Builder(
          name = "check_circle",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
...
internal var _outlinedCheckCircle: ImageVector? = null
