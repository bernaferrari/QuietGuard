...
import com.bernaferari.renetguard.data.db.AppEntity
import com.bernaferari.renetguard.data.db.DbCursors
import com.bernaferari.renetguard.data.db.LogEntity
...
class DatabaseHelper private constructor(
    ...
    fun addForward(protocol: Int, dport: Int, raddr: String, rport: Int, ruid: Int) {
        dbCall {
            dao.insertForward(
                com.bernaferari.renetguard.data.db.ForwardEntity(
                    protocol = protocol,
                    dport = dport,
                    raddr = raddr,
                    rport = rport,
