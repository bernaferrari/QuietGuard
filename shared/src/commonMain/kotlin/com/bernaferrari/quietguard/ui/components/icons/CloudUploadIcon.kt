...
internal val filledCloudUpload: ImageVector
  get() {
    if (_filledCloudUpload != null) {
      return _filledCloudUpload!!
    }
    _filledCloudUpload =
      ImageVector.Builder(
          name = "cloud_upload",
        ...
        .apply {
          path(
            ...
            reflectiveQuadTo(15.3f, 13.7f)
            quadTo(15.58f, 13.43f, 15.58f, 13f)
            reflectiveQuadTo(15.3f, 12.3f)
            lineTo(12.7f, 9.7f)
            quadTo(12.4f, 9.4f, 12f, 9.4f)
            reflectiveQuadTo(11.3f, 9.7f)
            lineTo(8.7f, 12.3f)
            quadTo(8.43f, 12.58f, 8.41f, 12.99f)
            reflectiveQuadTo(8.7f, 13.7f)
            quadToRelative(0.27f, 0.28f, 0.69f, 0.29f)
            reflectiveQuadTo(10.1f, 13.73f)
            lineTo(11f, 12.85f)
            verticalLineTo(20f)
...
internal var _filledCloudUpload: ImageVector? = null
