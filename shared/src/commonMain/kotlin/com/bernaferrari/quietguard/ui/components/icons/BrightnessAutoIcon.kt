...
internal val filledBrightnessAuto: ImageVector
  get() {
    if (_filledBrightnessAuto != null) {
      return _filledBrightnessAuto!!
    }
    _filledBrightnessAuto =
      ImageVector.Builder(
...
internal var _filledBrightnessAuto: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedBrightnessAuto: ImageVector
  get() {
    if (_outlinedBrightnessAuto != null) {
      return _outlinedBrightnessAuto!!
    }
    _outlinedBrightnessAuto =
      ImageVector.Builder(
          name = "brightness_auto",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
...
internal var _outlinedBrightnessAuto: ImageVector? = null
