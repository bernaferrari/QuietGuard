...
internal val filledPublic: ImageVector
  get() {
    if (_filledPublic != null) {
      return _filledPublic!!
    }
    _filledPublic =
      ImageVector.Builder(
          name = "public",
...
internal var _filledPublic: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedPublic: ImageVector
  get() {
    if (_outlinedPublic != null) {
      return _outlinedPublic!!
    }
    _outlinedPublic =
      ImageVector.Builder(
          name = "public",
...
internal var _outlinedPublic: ImageVector? = null
