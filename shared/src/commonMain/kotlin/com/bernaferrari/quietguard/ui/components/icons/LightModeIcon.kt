...
internal val filledLightMode: ImageVector
  get() {
    if (_filledLightMode != null) {
      return _filledLightMode!!
    }
    _filledLightMode =
      ImageVector.Builder(
          name = "light_mode",
...
internal var _filledLightMode: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedLightMode: ImageVector
  get() {
    if (_outlinedLightMode != null) {
      return _outlinedLightMode!!
    }
    _outlinedLightMode =
      ImageVector.Builder(
          name = "light_mode",
...
internal var _outlinedLightMode: ImageVector? = null
