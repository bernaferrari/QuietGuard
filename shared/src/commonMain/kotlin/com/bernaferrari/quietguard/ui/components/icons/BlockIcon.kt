...
internal val filledBlock: ImageVector
  get() {
    if (_filledBlock != null) {
      return _filledBlock!!
    }
    _filledBlock =
      ImageVector.Builder(
...
internal var _filledBlock: ImageVector? = null
@Suppress("CheckReturnValue")
internal val outlinedBlock: ImageVector
  get() {
    if (_outlinedBlock != null) {
      return _outlinedBlock!!
    }
    _outlinedBlock =
      ImageVector.Builder(
          name = "block",
...
internal var _outlinedBlock: ImageVector? = null
